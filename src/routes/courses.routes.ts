...
router.post("courses/:courseid/cover", permissionMiddleware("CREATE_COURSES"), upload.single("cover"), coverController.upload);
router.get("courses/:courseId/cover", permissionMiddleware("VIEW_COURSES"), coverController.show);
